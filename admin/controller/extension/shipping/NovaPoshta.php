...
class ControllerExtensionShippingNovaPoshta extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['shipping_NovaPoshta_cost'])) {
			$data['shipping_NovaPoshta_cost'] = $this->request->post['shipping_NovaPoshta_cost'];
		} else {
			$data['shipping_NovaPoshta_cost'] = $this->config->get('shipping_NovaPoshta_cost');
		}
